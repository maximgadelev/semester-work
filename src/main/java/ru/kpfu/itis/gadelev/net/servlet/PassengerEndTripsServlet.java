...
@WebServlet(urlPatterns = "/passengerEndTrips")
public class PassengerEndTripsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripDto> tripDtoList= passengersTripService.getPassengerTripsByStatus(passenger_id,"Завершена");
        req.setAttribute("passengersEndTrips",tripDtoList);
        req.getRequestDispatcher("EndPassengerTrips.ftl").forward(req,resp);
    }
}
